...
WebUI.setText(findTestObject('Object Repository/Page_Register/input_block px-2 py-3 mt-2 h-52px rounded-l_5154ab'), 'safarina lutfi01:&')

WebUI.setText(findTestObject('Object Repository/Page_Register/input_block px-2 py-3 mt-2 h-52px rounded-l_5154ab_1'), 'safarinalutfi')
